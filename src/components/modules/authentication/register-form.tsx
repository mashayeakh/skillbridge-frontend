        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-gray-50 via-white to-gray-100">
            ...
            >
                ...
                <motion.div
                    ...
                    className="mt-6 text-center text-xs text-gray-500 bg-white/80 backdrop-blur-sm p-3 rounded-lg border border-gray-200 shadow-sm"
                >
                    <p className="font-medium mb-1.5">Testing Account Suggestions</p>
                    <div className="text-left space-y-1">
                        <p className="text-gray-600">• Use a valid email for verification</p>
                        <p className="text-gray-600">• Phone format: +1 (555) 123-4567</p>
                        <p className="text-gray-600">• Password: At least 8 characters</p>
                    </div>
                </motion.div> */}
            </motion.div>
        </div>
